...
2.指定训练集和测试集。
3.训练集和测试集中的数值型变量(代谢物,菌群,蛋白等组学)做先做log2转换,随后z-score处理。如果有额外添加的指标(比如临床指标),则其中, 数值型变量做None处理。类别型变量one-hot编码。
4.选择一个机器学习模型, 在训练集中进行训练。并用2折交叉验证的方法找到最佳模型。
...
Mild_vs_moderate-severe_vs_Severe\
    |----data\
    |    |----Split1_Mild_vs_moderate-severe_vs_Severe_Test.txt # 第1次分割的测试数据。
    |    |----Split1_Mild_vs_moderate-severe_vs_Severe_Train.txt # 第1次分割的训练数据。
    |    |----Split2_Mild_vs_moderate-severe_vs_Severe_Test.txt
    |    |----Split2_Mild_vs_moderate-severe_vs_Severe_Train.txt
    |----MergedResult\ # 重要文件夹
    ...
    |    |    |----Importance\ # 特征重要性
    |    |    |    |----Split1_LASSO_variableImportance.txt
    |    |    |----Metric\ # 评价指标
    ...
    |    |    |----Importance\ # 特征重要性
    |    |    |    |----Split1_LR_variableImportance.txt
    |    |    |----Metric\ # 评价指标
    ...
    |    |    |----Importance\ # 特征重要性
    |    |    |    |----Split1_RFC_variableImportance.txt
    |    |    |----Metric\ # 评价指标
    ...
    |    |----SVM\
    |    |    |----Confusion\ # 混淆矩阵
    |    |    |    |----Test_Split1_SVM_confusion_matrix.jpg # 测试集中的混淆矩阵可视化
    |    |    |    |----Test_Split1_SVM_confusion_matrix.pdf
    |    |    |    |----Test_Split1_SVM_confusion_matrix.txt # 测试集中的混淆矩阵
    |    |    |    |----Train_Split1_SVM_confusion_matrix.jpg # 训练集中的混淆矩阵可视化
    |    |    |    |----Train_Split1_SVM_confusion_matrix.pdf
    |    |    |    |----Train_Split1_SVM_confusion_matrix.txt # 训练集中的混淆矩阵
    |    |    |----Importance\ # 特征重要性
    |    |    |    |----Split1_SVM_variableImportance.txt
    |    |    |----Metric\ # 评价指标
    |    |    |    |----Test_Split1_SVM_metrics.txt # 模型在测试集中的各种评价指标。
    |    |    |    |----Train_Split1_SVM_metrics.txt # 模型在训练集中的各种评价指标。
    |    |    |----ROC\
    |    |    |    |----Test_Split1_SVM_roc_curve.jpg # 测试集中的ROC曲线
    |    |    |    |----Test_Split1_SVM_roc_curve.pdf
    |    |    |    |----Test_Split1_SVM_roc_curve.txt # 测试集中用于做ROC曲线的数据。
    |    |    |    |----Test_Split1_SVM_TrueAndPredict.txt# 在测试集中模型预测为某一类的概率,以及模型实际预测的值和真值。
    |    |    |    |----Train_Split1_SVM_roc_curve.jpg # 训练集中的ROC曲线
    |    |    |    |----Train_Split1_SVM_roc_curve.pdf
    |    |    |    |----Train_Split1_SVM_roc_curve.txt # 训练集中用于做ROC曲线的数据。
    |    |    |    |----Train_Split1_SVM_TrueAndPredict.txt # 在训练集中模型预测为某一类的概率,以及模型实际预测的值和真值。
    |    |    |----SavedModel\
    |    |    |    |----Split1_SVM.pkl # 保存的最佳模型。
    |    |    |    |----Split1_SVM.txt # 模型的最佳超参数。
    |    |----XGBOOST\
    |    |    |----Confusion\ # 混淆矩阵
    ...
    |    |    |----Importance\ # 特征重要性
    |    |    |    |----Split1_XGBOOST_variableImportance.txt
    |    |    |----Metric\ # 评价指标
    ...
    |    |----SVM\
    |    |    |----Confusion\ # 混淆矩阵
    |    |    |    |----Test_Split2_SVM_confusion_matrix.jpg
    |    |    |    |----Test_Split2_SVM_confusion_matrix.pdf
    |    |    |    |----Test_Split2_SVM_confusion_matrix.txt
    |    |    |    |----Train_Split2_SVM_confusion_matrix.jpg
    |    |    |    |----Train_Split2_SVM_confusion_matrix.pdf
    |    |    |    |----Train_Split2_SVM_confusion_matrix.txt
    |    |    |----Importance\ # 特征重要性
    |    |    |    |----Split2_SVM_variableImportance.txt
    |    |    |----Metric\ # 评价指标
    |    |    |    |----Test_Split2_SVM_metrics.txt
    |    |    |    |----Train_Split2_SVM_metrics.txt
    |    |    |----ROC\
    |    |    |    |----Test_Split2_SVM_roc_curve.jpg
    |    |    |    |----Test_Split2_SVM_roc_curve.pdf
    |    |    |    |----Test_Split2_SVM_roc_curve.txt
    |    |    |    |----Test_Split2_SVM_TrueAndPredict.txt
    |    |    |    |----Train_Split2_SVM_roc_curve.jpg
    |    |    |    |----Train_Split2_SVM_roc_curve.pdf
    |    |    |    |----Train_Split2_SVM_roc_curve.txt
    |    |    |    |----Train_Split2_SVM_TrueAndPredict.txt
    |    |    |----SavedModel\
    |    |    |    |----Split2_SVM.pkl
    |    |    |    |----Split2_SVM.txt
    |    |----XGBOOST\
