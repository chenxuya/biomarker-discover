...
Mild_vs_moderate-severe\
    |----data\
    |    |----Split1_Mild_vs_moderate-severe_Test.txt # 模型的最佳超参数。
    |    |----Split1_Mild_vs_moderate-severe_Train.txt # 模型的最佳超参数。
    |    |----Split2_Mild_vs_moderate-severe_Test.txt
    |    |----Split2_Mild_vs_moderate-severe_Train.txt
    |----MergedResult\ # 重要文件夹
